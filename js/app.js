...
constSeattle = document.createEl




let hours = ["6am", "7am", "8am", "9am", "10am", "11am", "12pm", "1pm", "2pm"]
...
function estimate(store) {
  ...
  for (let i=0; i < hours.length; i++)
    const numCustomers = random( store.minCustomersPerHour, store.)//something here
    const hourlySales = Math.ceil(numCustomers * store.averageCookies);//here
